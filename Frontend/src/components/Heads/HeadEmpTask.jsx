...
function HeadEmpTask() {
  ...
  useEffect(() => {
    async function getTasks() {
      try {
        ...
        const res = await axios.get(`task/getall/${id}`, config);
  ...
  function filterContent(Task, searchTerm) {
    const result = Task.filter(
      (r) =>
        ...
        r.lastUpdatedDate.includes(searchTerm)
    );
    setTask(result);
  }
  ...
  const handleTextSearch = (e) => {
    ...
    axios.get(`task/getall/${id}`, config).then((res) => {
      if (res.data.tasks) {
          ...
          <form class="flex items-center mt-10">
            ...
            <div class="relative w-[300px] ml-[230px]">
              ...
              <input
                ...
                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <input
              ...
              id="simple-search"
              onChange={handleTextSearch}
              class="bg-white border ml-5 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search by ID or Name"
              required
            />
          </form>
            ...
            <tbody class="divide-y divide-gray-400">
              {Task.filter((r) =>
                ...
                <tr key={index} class="bg-gray-200 hover:bg-slate-100">
                  ...
                  <td class="px-6 py-4 text-center">{Task.lastUpdatedDate}</td>
